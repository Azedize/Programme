    ...
    "login": [
        ...
        {"action": "check_if_exist", "xpath":"//a[starts-with(@href,'https://accounts.google.com/AccountChooser')] | //input[@id='identifierId'] | //div[@id='gbwa'] | //div[@id='main-message']", "wait": 6, "sleep": 0,
            ...
            "sub_action": [
                    ...
                    "sub_action": [
                        ...
                        {"id":1,"action": "press_keys", "xpath": "//button[.//span[text()='Suivant']] | //button[.//span[text()='Next']]", "wait": 1, "sleep": 5 ,
                            "sub_action": [
                                ...
                                {"action": "check_if_exist", "xpath": "(//a[@aria-label='Try to restore' or @aria-label='Essayer de restaurer']) | (//form//div[contains(text(), 'robot')])", "wait": 4,"sleep": 0,
                                     "sub_action":[
                            ...
                            "sub_action": [
                                ...
                                {"action": "check_if_exist", "xpath": "//div[@aria-live='polite']//div[@aria-hidden='true']/following-sibling::div//span | (//a[(text()='En savoir plus' or  text()='Learn more')]) | //input[@id='knowledgePreregisteredEmailInput']", "wait": 3,"sleep": 0, 
                                    ...
                                    "sub_action": [
                                        ...
                                        {"action": "check_if_exist", "xpath":  "//a[(text()='En savoir plus' or text()='Learn more')]/ancestor::div[1][contains(., 'détecté') or contains(., 'detected')]"   , "wait": 1,"sleep": 0, 
                                            "sub_action": [
                ...
                {"action": "check_if_exist", "xpath": "//*[@id='headingText']", "wait": 2,"sleep": 0, 
                    "sub_action": [
                        {"action": "check_if_exist", "xpath": "//*[@id='headingText']", "wait": 1, "sleep": 0 , "obligatoire":true , "type":"account_closed"},   // account_closed
                    ]
                }
